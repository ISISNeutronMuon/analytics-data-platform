with source as (
    ...
    select * from {{ source('source_accelerator_accelerator_sharepoint', 'equipment_downtime_data_11_08_24') }}
...
renamed as (
    ...
    select
        ...
        {{ parse_utc_timestamp('fault_date_str', 'yyyy-MM-dd', 'fault_time_str', source_accelerator_timezone='Europe/London') }} as fault_occurred_at,
