...
Optionally, to provision and monitoring the Airflow services, use `airflow` profile:
...
_Note: There is currently an issue with the table preview tab being broken. See [#329](https://github.com/ISISNeutronMuon/analytics-data-platform/issues/329)._
